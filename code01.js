...
//====================================================================================================	
	...
	var jan = [1100, 1150, 1210, 1000, 1050]
	var fev = [840, 880, 930, 670, 710]
	var mar = [760, 800, 840, 620, 650]
	var abr = [760, 800, 840, 620, 650]
	var mai = [660, 725, 820, 590, 650]
	var jun = [660, 725, 820, 590, 650]
	var jul = [745, 820, 900, 615, 680]
	var ago = [630, 700, 750, 550, 600]
	var set = [670, 700, 750, 550, 600]
	var out = [730, 780, 820, 600, 650]
	var nov = [800, 840, 880, 670, 740]
	var dez = [900, 950, 990, 740, 800]
